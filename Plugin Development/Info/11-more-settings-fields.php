...
// Full collection of setting fields
...
function wpplugin_settings() {
  ...
  add_settings_field(
    ...
    'wpplugin',
    'wpplugin_settings_section',
    // passing in additional arguments we can use in the callback function
    [
...
// passing in checkbox label as $args
...
function wpplugin_settings_radio_callback( $args ) {
  ...
  // RADIO BUTTONS NEED DIFFERENT LABEL
...
function wpplugin_settings_select_callback( $args ) {
  ...
  // if dropdown matches value, display value
